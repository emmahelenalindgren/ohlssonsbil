var vanillacalendar = {
  ...
  createDay: function (num, day, year) {
    ...
    newDay.setAttribute('data-calendar-date', this.date.getDate() + "/" + (this.date.getMonth()+ 1) + "/" + this.date.getFullYear())
    newDay.setAttribute('datum', this.date.getDate())
    newDay.setAttribute('manad', this.date.getMonth() + 1) 
    newDay.setAttribute('aret', this.date.getFullYear())
    if (num === 1) {
